    ...
    <main>
      ...
      <div className="groups-container">
        <div className="group-card">
          ...
          <a href="#" className="view-more">View History</a>
        </div>
      </div>
      ...
      <div className="create-group-container">
        <form className="create-group-form">
          <div className="form-group">
            ...
            <input type="text" id="group-name" placeholder="Enter a name for your group" />
          </div>
          <div className="form-group">
            <label htmlFor="group-description">Description</label>
            <textarea id="group-description" placeholder="Describe your group's focus and goals"></textarea>
          </div>
          <div className="form-group">
