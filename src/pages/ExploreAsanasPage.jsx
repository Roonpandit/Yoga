  ...
  return (
    <div className="asana-card">
      <div className="asana-header">
        ...
        <span className={`asana-difficulty difficulty-${asana.difficulty}`}>{asana.difficulty}</span>
      </div>
  ...
  const asanas = [
    {
      ...
      benefits: ["Strengthens arms and legs", "Stretches shoulders, hamstrings, and calves", "Energizes the body"]
    },
    {
    ...
    },
    {
      ...
      benefits: ["Strengthens arms and wrists", "Builds core strength", "Improves balance and focus"]
    },
    {
      name: "Headstand (Sirsasana)",
      difficulty: 5,
      description: "An advanced inversion that requires strength, balance, and proper alignment.",
      benefits: ["Strengthens shoulders and core", "Improves circulation", "Builds confidence"]
    },
    {
      name: "Lotus Pose (Padmasana)",
      difficulty: 3,
      description: "A seated meditation pose that requires open hips and flexibility in the knees.",
      benefits: ["Opens hips", "Stretches knees and ankles", "Creates a stable base for meditation"]
    }
  ];
  
  const filteredAsanas = asanas.filter(asana => {
    const matchesDifficulty = filterDifficulty === 'all' || asana.difficulty === parseInt(filterDifficulty);
