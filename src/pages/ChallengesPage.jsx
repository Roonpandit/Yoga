  ...
  const userChallenges = [
    {
      ...
      difficulty: 'Medium',
      description: 'Complete 30 flexibility-focused asanas in 30 days. Track your progress and rate each asana\'s difficulty.',
      progress: 40,
  ...
  const completedChallenges = [
    {
      ...
      difficulty: 'Easy',
      description: 'Complete a 10-minute morning yoga routine for 14 consecutive days.',
      progress: 100,
            ...
            {userChallenges.map((challenge, index) => (
              <div className="challenge-card" key={index}>
                <div className="challenge-header">
                  ...
                  <div className="challenge-difficulty">Difficulty: {challenge.difficulty}</div>
                </div>
      ...
      <div className="create-challenge-section">
        ...
        <form className="create-challenge-form">
          <div className="form-group">
            ...
            <input type="text" id="challenge-name" placeholder="Enter a name for your challenge" />
          </div>
          <div className="form-group">
          ...
          <div className="form-group">
            ...
            <input type="number" id="challenge-duration" min="1" max="90" defaultValue="30" />
          </div>
